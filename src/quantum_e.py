...
class calc:
    def __init__(
        ...
        hasrun=False,
        rundir='/.',
        runexe=os.environ.get('QE_BASE')+'/bin/pw.x',
        ipname='QE.in',
        ouname='QE.out',
        
        #input structure
        inmole=ml.molec(name='general'),
        #eventuall i would like to make my own kpoint generator but for now i will just use text
        #kponts=np.array([[0, 0, 0, 1]]),
        kponts='K_POINTS {automatic} \n 1 1 1 0 0 0',
